...
#define ELECTROSTATIC_DISCRETIZATION_TYPE_MAP(X) \
    X(ELECTROSTATIC_DISCRETIZATION_STANDARD, STANDARD) \
    X(ELECTROSTATIC_DISCRETIZATION_MEHRSTELLEN4, MEHRSTELLEN4)
...
#define SMOOTHING_TYPE_MAP(X) \
    ...
    X(SMOOTHING_TYPE_WENDLAND_C2_POLY, WENDLANDC2_POLY) \
    X(SMOOTHING_TYPE_WENDLAND_C4_POLY, WENDLANDC4_POLY)
...
DEFINE_ENUM(electrostatic_discretization_type, ELECTROSTATIC_DISCRETIZATION_TYPE_MAP)
