...
#define SMOOTHING_TYPE_MAP(X) \
    ...
    X(SMOOTHING_TYPE_WENDLAND_C2, WENDLANDC2) \
    X(SMOOTHING_TYPE_WENDLAND_C4, WENDLANDC4) \
    X(SMOOTHING_TYPE_WENDLAND_C2_NOFFT, WENDLANDC2_NOFFT) \
    X(SMOOTHING_TYPE_WENDLAND_C4_NOFFT, WENDLANDC4_NOFFT)
